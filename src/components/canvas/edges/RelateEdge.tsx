...
// Dashed line with a midpoint ◇ — "how are these two related?" It stays
// visible while the articulation ghost is still forming (empty frame), and
// Canvas.tsx hides it (edge + diamond) once the ghost starts streaming
// content; on accept it's replaced by the two materialized legs (also
// relate-styled), on reject it's removed (use-canvas-persistence.ts).
//
